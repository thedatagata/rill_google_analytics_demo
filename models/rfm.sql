...
SELECT
  ...
  , AVG(COALESCE(e.total_transaction_revenue, 0) / 1000000.0) AS monetary_value
  , SUM(COALESCE(e.total_transaction_revenue, 0) / 1000000.0) AS total_revenue

FROM source_session_facts e
GROUP BY 1